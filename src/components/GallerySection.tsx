...
const photos = [
  ...
  { src: outdoorImg, alt: "Outdoor café",      tall: true  },
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <span className="font-body text-xs tracking-[0.4em] uppercase" style={{ color: "hsl(var(--secondary))" }}>Atmosphere</span>
            <div className="h-px w-16" style={{ background: "hsl(var(--secondary))" }} />
          </div>
          ...
          <p className="font-body text-base mt-4 max-w-xl mx-auto" style={{ color: "hsl(var(--muted-foreground))" }}>
            A glimpse into the MEGS world — food, drinks and the people who love them.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <a
            ...
            className="inline-flex items-center gap-3 font-body text-sm font-medium tracking-widest uppercase px-8 py-4 rounded-full border-2 transition-all duration-300 hover:opacity-80"
